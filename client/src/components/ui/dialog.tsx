...
>(({ className, children, 'aria-describedby': ariaDescribedBy, ...props }, ref) => {
  // Если aria-describedby не указан явно, устанавливаем undefined для подавления предупреждения
  const finalAriaDescribedBy = 'aria-describedby' in props && props['aria-describedby'] !== undefined
